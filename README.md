# KMParse
A Very WIP Modern Mario Kart Wii KMP Editor based on Lonrenzi's KMP Editor.

## Features
- The operation method is almost the same as Lorenzi's KMP Editor, which makes it easy to switch from Lorenzi's KMP Editor.
